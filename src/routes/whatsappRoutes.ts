...
} from "../service/sendWhatsAppMessage";
...
import { ensureCalendarSettings } from "../service/calendarService";
import { ensureAvailabilityDays } from "../service/availabilityDaysService"; // <-- adjust path if needed
